...
- **Notes:** Keep existing `generate-request-batch` behavior stable; prefer additive CLI/API surface; do not treat `.ogg` requests as optional success paths for SESSION-009.
