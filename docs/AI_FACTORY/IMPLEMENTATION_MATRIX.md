...
| Backend registry discovery in CLI | implemented | `audio_engine/ai/backend.py`, `audio_engine/cli.py` (`list-backends`) | 2026-05-15 | `pytest` | Backends are listable via CLI for explicit availability/discovery before generation runs. |
