...
| AI factory review-state workflow | docs-contract | `docs/AI_FACTORY/QA/REVIEW_WORKFLOW.md`, `docs/AI_FACTORY/EXAMPLES/gamerewritten_vertical_slice/review_log.example.v1.json` | 2026-05-15 | Manual doc review, JSON parse checks | Variant-family review/report template guidance is now documented; add executable review-log writer next. |
