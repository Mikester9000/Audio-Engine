...
- baseline repo verification passed (full `pytest` 1129 passed + asset-manifest validation)
- targeted instrument-identity regression slices passed (111 selected tests)
