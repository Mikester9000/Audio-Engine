...
- baseline repo verification passed (full `pytest` 1108 passed + asset-manifest validation)
- targeted studio/style/SFX regression slices passed (55 selected tests)
