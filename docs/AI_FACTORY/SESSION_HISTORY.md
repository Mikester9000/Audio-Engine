...
| `SESSION-011` | 2026-05-15 | completed | Added backend evaluation notes and dependency/availability guidance aligned with backend discovery/selection CLI surfaces; documented truthful current backend reality vs future adapter direction. | this PR |
| `SESSION-012` | 2026-05-15 | completed | Added deterministic repeated-SFX variation strategy guidance (variant-per-request, stable naming, explicit seed capture) as docs-contract behavior without claiming runtime variation automation. | this PR |
