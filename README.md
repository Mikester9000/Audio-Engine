...
- Detailed machine-readable current session: [`docs/AI_FACTORY/CURRENT_SESSION.json`](docs/AI_FACTORY/CURRENT_SESSION.json)
- Session completion gates: [`docs/AI_FACTORY/SESSION_GATE_RULES.md`](docs/AI_FACTORY/SESSION_GATE_RULES.md)
- Blocker procedure: [`docs/AI_FACTORY/BLOCKER_PROTOCOL.md`](docs/AI_FACTORY/BLOCKER_PROTOCOL.md)
...
- Verification by task type: [`docs/AI_FACTORY/VERIFICATION_PROFILES.md`](docs/AI_FACTORY/VERIFICATION_PROFILES.md)
- Minimum test-expansion rules: [`docs/AI_FACTORY/MINIMUM_TEST_EXPANSION_RULES.md`](docs/AI_FACTORY/MINIMUM_TEST_EXPANSION_RULES.md)
- Code locator map: [`docs/AI_FACTORY/CODEBASE_MAP.md`](docs/AI_FACTORY/CODEBASE_MAP.md)
- Canonical output layout: [`docs/AI_FACTORY/CANONICAL_OUTPUT_LAYOUT.md`](docs/AI_FACTORY/CANONICAL_OUTPUT_LAYOUT.md)
- Full game-audio coverage checklist: [`docs/AI_FACTORY/FULL_GAME_AUDIO_CHECKLIST.md`](docs/AI_FACTORY/FULL_GAME_AUDIO_CHECKLIST.md)
- Low-prompt command guide: [`docs/AI_FACTORY/HUMAN_COMMANDS.md`](docs/AI_FACTORY/HUMAN_COMMANDS.md)
