...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/integration/cpp/AudioSystem.hpp`
- **Line where code is to be edited or create:** Edit `L303-L345`, `L462-L485`, `L562-L626`; create new helper/state code around the private helper/member section after `L579`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/integration/game_state_map.py`
- **Line where code is to be edited or create:** Edit `L116-L197` and `L204-L249`; create new manifest blocks after `L249`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/ai/sfx_synth.py`
- **Line where code is to be edited or create:** Extend recipe functions after `L148-L260`; update alias registry at `L746-L861`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/ai/generator.py`
- **Line where code is to be edited or create:** Edit `L58-L92` and extend `_STYLE_DEFS` beginning at `L116`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/ai/music_gen.py`
- **Line where code is to be edited or create:** Edit constructor and generation path at `L55-L180`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/integration/asset_pipeline.py`
- **Line where code is to be edited or create:** Edit `L722-L910`; add new orchestration code near `L1433-L1843` and supporting export/approval integration before the later pipeline classes.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/cli.py`
- **Line where code is to be edited or create:** Edit `_resolve_backend` at `L88-L106`, command helpers near `L136-L223`, parser blocks at `L988-L1941`, and dispatch map at `L2210-L2214`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/integration/lua/audio.lua`
- **Line where code is to be edited or create:** Edit `L54-L84`, `L94-L220`, and create new hook wrappers after the current helper/hook blocks.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/docs/AI_FACTORY/EXAMPLES/gamerewritten_vertical_slice/generation_requests.music.v1.json`
- **Line where code is to be edited or create:** Edit the existing request list at `L1-L520`; append new entries after the current last request block.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/docs/AI_FACTORY/EXAMPLES/gamerewritten_vertical_slice/generation_requests.sfx.v1.json`
- **Line where code is to be edited or create:** Edit `L1-L227`; append new request families and variant entries after the current last block.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/docs/AI_FACTORY/EXAMPLES/gamerewritten_vertical_slice/audio_plan.vertical_slice.v1.json`
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/ai/radio_playlist.py`
- **Line where code is to be edited or create:** Edit preset/generator areas at `L105-L106`, `L291-L433`, and related helper code through `L542`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/dsp/ps1_effects.py`
- **Line where code is to be edited or create:** Edit `L38-L86`, constructor region `L130-L140`, and reverb processing path starting at `L207`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/ai/ps1_backend.py`
- **Line where code is to be edited or create:** Edit constructor and generation flow at `L54-L139`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/audio_engine/render/offline_bounce.py`
- **Line where code is to be edited or create:** Edit `L31-L34`, constructor profile defaults at `L98-L131`, EQ build logic at `L150-L171`, and profile-dependent processing at `L208-L218`.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/docs/AI_FACTORY/FULL_GAME_AUDIO_CHECKLIST.md`
- **Line where code is to be edited or create:** Edit `L21-L145`; add annotations or completion marks inline where coverage becomes real.
...
- **Name of the file to be edited or create:** `/home/runner/work/Audio-Engine/Audio-Engine/docs/AI_FACTORY/KNOWN_ISSUES.md`
- **Line where code is to be edited or create:** Edit `L1-L39`; add new issue entries in the current high-impact gaps section.
