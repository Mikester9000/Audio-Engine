...
FF_RADIO_CATALOG: list[TrackEntry] = [
    ...
    TrackEntry("synth_house_modern","Modern Synth House",  "generic","Generic",              "theme",     124, "uplifting", False, "Unknown",         "synth-house-modern",["house","synth","electronic","modern","festival","dance"]),
    TrackEntry("techno_drive",      "Techno Drive",        "generic","Generic",              "theme",     132, "driving",   False, "Unknown",         "techno-drive",      ["techno","electronic","dark","club","driving","synth"]),
    TrackEntry("trance_uplift",     "Trance Uplift",       "generic","Generic",              "theme",     136, "euphoric",  False, "Unknown",         "trance-uplift",     ["trance","uplifting","electronic","supersaw","synth","anthemic"]),
    TrackEntry("drum_and_bass_neuro","Drum and Bass Neuro","generic","Generic",              "battle",    172, "aggressive",False, "Unknown",         "drum-and-bass-neuro",["drum and bass","dnb","neurofunk","electronic","bass","breakbeat"]),
    TrackEntry("future_bass_modern","Future Bass Modern",  "generic","Generic",              "theme",     150, "emotional", False, "Unknown",         "future-bass-modern",["future bass","electronic","modern pop","synth","chopped chords","cinematic"]),
    # Metal
...
_ALIAS_MAP: dict[str, str] = {
    ...
    "house":                   "synth_house_modern",
    "synth house":             "synth_house_modern",
    "techno":                  "techno_drive",
    "trance":                  "trance_uplift",
    "drum and bass":           "drum_and_bass_neuro",
    "dnb":                     "drum_and_bass_neuro",
    "future bass":             "future_bass_modern",
    "metal":                   "metal_epic",
...
_MOOD_STYLE_MAP: list[tuple[list[str], str]] = [
    ...
    (["house", "synth house", "progressive house", "festival house"],      "synth_house_modern"),
    (["techno", "acid techno", "warehouse techno"],                         "techno_drive"),
    (["trance", "uplifting trance", "euphoric trance"],                     "trance_uplift"),
    (["drum and bass", "dnb", "neurofunk", "liquid drum and bass"],         "drum_and_bass_neuro"),
    (["future bass", "future pop bass", "chopped chords"],                  "future_bass_modern"),
