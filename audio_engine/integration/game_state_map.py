...
MUSIC_MANIFEST: tuple[MusicAsset, ...] = (
    ...
    MusicAsset(
        ...
        style="tension",
        prompt="low-intensity stealth tension underscore with pulsing bass and subtle strings 80 BPM loopable",
        duration=60.0,
        loopable=True,
    ),
    MusicAsset(
    ...
    MusicAsset(
        ...
        style="battle",
        prompt="short battle intro sting with immediate orchestral hit and rising tension",
        duration=3.0,
        loopable=False,
    ),
    MusicAsset(
